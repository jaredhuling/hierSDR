...
pdf(paste0(fig.path, "sim_2a_nvars100_misspecified_boxplots.pdf"), height = 8, width = 10)
...
pdf(paste0(fig.path, "sim_2a_directions_nvars100_misspecified_boxplots.pdf"), height = 8, width = 10)
...
pdf(paste0(fig.path, "sim_2b_nvars50_misspecified_boxplots.pdf"), height = 8, width = 10)
...
pdf(paste0(fig.path, "sim_2b_directions_nvars50_misspecified_boxplots.pdf"), height = 8, width = 10)
